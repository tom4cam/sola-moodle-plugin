...
$string['settings:avatar_color'] = 'Avatar Button Color';
$string['settings:avatar_color_desc'] = 'Accent color for the floating avatar button (border + shadow). Use a hex value, e.g. #4a6cf7.';
